...
%PROG% 0 32 "data\seek32k\Data_%%04d.bmp" "result\seek32k_result_%%02d.png" 32 2
%PROG% 0 16 "data\seek32k\Data_%%04d.bmp" "result\seek32k_resulta_%%02d.png" 16 2
%PROG% 16 16 "data\seek32k\Data_%%04d.bmp" "result\seek32k_resultb_%%02d.png" 16 2
